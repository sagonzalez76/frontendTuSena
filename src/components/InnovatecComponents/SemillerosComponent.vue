<template>
    <main class="container mt-4 pt-0">
        ...
        <h3 class="fw-bold text-center text-dark">SEMILLEROS</h3>

        <h6 class="fw-bold text-center text-dark">Estos son los semilleros del grupo de investigación INNOVATEC CTPI:</h6>
